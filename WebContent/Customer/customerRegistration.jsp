    ...
    <div style="margin-left:20%">
         <div class="my-new-header">
             ...
             <div class="navbar-userpart">
                <span class="navbar-userpart-username">Welcome, Customer </span> 
             </div>
         </div>
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input type="password" name="customer_pwd" id="customer_pwd"  required>
                        </div>
                    </div>                        
                </div>   
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-3">
                            <label for="customer_type">Organization Type</label>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <textarea name="customer_address" id="customer_address" cols="22" rows="2" required></textarea>
                        </div>
                    </div>                                                
                </div> 
                <br><br>
